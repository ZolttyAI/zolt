"""
Mini-batch K-means clustering over z1 hidden-state embeddings.
...
to operate on cosine geometry, matching how z1 embeddings are used elsewhere.
"""
...
def extract_embeddings(
    ...
    Args:
        model:         Z1ForCausalLM instance in eval mode.
