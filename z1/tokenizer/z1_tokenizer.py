"""
Tokenizer interface with z1 special tokens for reasoning and coding agent interactions.
"""
...
class Z1Tokenizer:
    """BPE tokenizer wrapper with special token IDs for z1."""
    ...
    def wrap_tool_call(self, tool_json: str, response_json: str) -> str:
        """Wrap tool call and response JSON in z1 tool tags."""
        return f"<tool_call>\n{tool_json}\n</tool_call>\n<tool_response>\n{response_json}\n</tool_response>"
    ...
    def __repr__(self) -> str:
        return f"Z1Tokenizer(vocab_size={self.vocab_size})"

    @classmethod
    def from_pretrained(cls, path: str) -> "Z1Tokenizer":
        return cls(path)
